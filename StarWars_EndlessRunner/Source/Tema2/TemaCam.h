...
namespace TemaCam
{
	...
	public:
		...
		void TranslateForward(float distance)
		{
			...
			this->position += glm::vec3(0,0,-distance);
		}
		...
		void TranslateRight(float distance)
		{
			...
			this->position += glm::vec3(1, 0, 0) * distance;
		}
		...
		void RotateFirstPerson_OZ(float angle)
		{
			...
			up = glm::normalize(glm::vec3(glm::rotate(glm::mat4(1), angle, glm::vec3(0, 0, 1)) * glm::vec4(up, 1)));
		}
